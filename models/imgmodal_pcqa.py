...
from models.transformer_img import (
...
class CMA_fusion(nn.Module):
    ...
    def forward(
        ...
        # texture_img_token = self.linear1(texture_img_token)
        # texture_img_token = texture_img_token.permute(0, 2, 1)
        # texture_img_token = self.img_bn( texture_img_token)

        # # linear mapping and batch normalization for geometry map
        # depth_img_token = self.linear1(depth_img_token)
        # depth_img_token = depth_img_token.permute(0, 2, 1)
        # depth_img_token = self.img_bn(depth_img_token)
        ...
        # output_global = tex_img_global + geometry_img_global + tex2D_geo2D_global_attention + geo2D_tex2D_global_attention
